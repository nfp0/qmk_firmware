...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT(
    ...
    _______, XXXXXXX, KC_UP,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_INS,  KC_HOME, KC_UP,   KC_END, KC_PGUP,  XXXXXXX,          KC_DEL,  KC_VOLD, \
    TG(2),   KC_LEFT, KC_DOWN, KC_RGHT, KC_PSCR, KC_SLCK, KC_PAUS, XXXXXXX, XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, _______,                            \
