...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    ...
    KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                             KC_LALT, KC_RGUI, MO(2),            RCTLARR, KC_DOWN, KC_RGHT  \
    ),
  ...
  [2] = LAYOUT(
    ...
    TG(1),   XXXXXXX, XXXXXXX, KC_PSCR, KC_SLCK, KC_PAUS, XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, XXXXXXX, XXXXXXX, _______,                            \
    _______, KC_GRV,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, S(KC_7), XXXXXXX, XXXXXXX,          KC_MPLY,          \
    _______, _______, _______,                            KC_APP,                             XXXXXXX, XXXXXXX, _______,          KC_MPRV, KC_MUTE, KC_MNXT  \
  ),
};
