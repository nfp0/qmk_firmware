...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT(
    ...
    _______, KC_HOME, KC_UP,   KC_END,  KC_PGUP, XXXXXXX, XXXXXXX, XXXXXXX, KC_INS,  KC_HOME, KC_PGUP, LBRC,    RBRC,    XXXXXXX,          KC_DEL,  KC_VOLD, \
    TG(2),   KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, XXXXXXX, KC_PSCR, KC_SLCK, KC_PAUS, KC_END,  KC_PGDN, LCBR,    RCBR,    _______,                            \
